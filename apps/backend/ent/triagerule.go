...
// TriageRule is the model entity for the TriageRule schema.
...
func (*TriageRule) scanValues(columns []string) ([]any, error) {
	values := make([]any, len(columns))
	for i := range columns {
		switch columns[i] {
		case triagerule.FieldConditions, triagerule.FieldEnrichment:
			values[i] = new([]byte)
		case triagerule.FieldEnabled:
			values[i] = new(sql.NullBool)
		case triagerule.FieldPriority:
			values[i] = new(sql.NullInt64)
		case triagerule.FieldName, triagerule.FieldDescription, triagerule.FieldMatchMode, triagerule.FieldDecision, triagerule.FieldSeverity, triagerule.FieldCategory:
			values[i] = new(sql.NullString)
		case triagerule.FieldCreatedAt, triagerule.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case triagerule.FieldID, triagerule.FieldCreatedBy:
...
// to the TriageRule fields.
func (_m *TriageRule) assignValues(columns []string, values []any) error {
	if m, n := len(values), len(columns); m < n {
		return fmt.Errorf("mismatch number of scan values: %d != %d", m, n)
	}
	for i := range columns {
		switch columns[i] {
		case triagerule.FieldID:
			if value, ok := values[i].(*uuid.UUID); !ok {
				return fmt.Errorf("unexpected type %T for field id", values[i])
			} else if value != nil {
				_m.ID = *value
			}
		case triagerule.FieldName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field name", values[i])
			} else if value.Valid {
				_m.Name = value.String
			}
		case triagerule.FieldDescription:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field description", values[i])
			} else if value.Valid {
				_m.Description = value.String
			}
		case triagerule.FieldConditions:
		...
		case triagerule.FieldCreatedBy:
			if value, ok := values[i].(*uuid.UUID); !ok {
				return fmt.Errorf("unexpected type %T for field created_by", values[i])
			} else if value != nil {
				_m.CreatedBy = *value
			}
		case triagerule.FieldCreatedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field created_at", values[i])
			} else if value.Valid {
				_m.CreatedAt = value.Time
			}
		case triagerule.FieldUpdatedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
...
// Value returns the ent.Value that was dynamically selected and assigned to the TriageRule.
// This includes values selected through modifiers, order, etc.
func (_m *TriageRule) Value(name string) (ent.Value, error) {
...
func (_m *TriageRule) Update() *TriageRuleUpdateOne {
	return NewTriageRuleClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the TriageRule entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *TriageRule) Unwrap() *TriageRule {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("ent: TriageRule is not a transactional entity")
	}
...
func (_m *TriageRule) String() string {
	var builder strings.Builder
	builder.WriteString("TriageRule(")
...
// TriageRules is a parsable slice of TriageRule.
type TriageRules []*TriageRule
