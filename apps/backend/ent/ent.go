...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			agentask.Table:                         agentask.ValidColumn,
			agentdmmessage.Table:                   agentdmmessage.ValidColumn,
			...
			alertinvestigationalert.Table:          alertinvestigationalert.ValidColumn,
			alertinvestigationevent.Table:          alertinvestigationevent.ValidColumn,
			alertinvestigationupdateentry.Table:    alertinvestigationupdateentry.ValidColumn,
			auditlog.Table:                         auditlog.ValidColumn,
			coordinationtask.Table:                 coordinationtask.ValidColumn,
			counter.Table:                          counter.ValidColumn,
			credentialprovider.Table:               credentialprovider.ValidColumn,
			deliverytarget.Table:                   deliverytarget.ValidColumn,
			escalationpolicy.Table:                 escalationpolicy.ValidColumn,
			handoffrecord.Table:                    handoffrecord.ValidColumn,
			heartbeat.Table:                        heartbeat.ValidColumn,
			icsroleassignment.Table:                icsroleassignment.ValidColumn,
			incident.Table:                         incident.ValidColumn,
			incidentcoordinationmessage.Table:      incidentcoordinationmessage.ValidColumn,
			incidentdocument.Table:                 incidentdocument.ValidColumn,
			incidentinvestigation.Table:            incidentinvestigation.ValidColumn,
			incidentinvestigationupdateentry.Table: incidentinvestigationupdateentry.ValidColumn,
			incidenttimelineentry.Table:            incidenttimelineentry.ValidColumn,
			integration.Table:                      integration.ValidColumn,
			investigationthread.Table:              investigationthread.ValidColumn,
			investigationthreadmessage.Table:       investigationthreadmessage.ValidColumn,
			knowledgenote.Table:                    knowledgenote.ValidColumn,
			maintenancewindow.Table:                maintenancewindow.ValidColumn,
			notification.Table:                     notification.ValidColumn,
			notificationdeliverylog.Table:          notificationdeliverylog.ValidColumn,
			...
			playbookstep.Table:                     playbookstep.ValidColumn,
			postmortem.Table:                       postmortem.ValidColumn,
			routerules.Table:                       routerules.ValidColumn,
			schedulelayer.Table:                    schedulelayer.ValidColumn,
			scheduleoverride.Table:                 scheduleoverride.ValidColumn,
			service.Table:                          service.ValidColumn,
			servicedependency.Table:                servicedependency.ValidColumn,
			session.Table:                          session.ValidColumn,
			sharedsecret.Table:                     sharedsecret.ValidColumn,
			statuspage.Table:                       statuspage.ValidColumn,
			statuspagecomponent.Table:              statuspagecomponent.ValidColumn,
			systemconfig.Table:                     systemconfig.ValidColumn,
			team.Table:                             team.ValidColumn,
			teammember.Table:                       teammember.ValidColumn,
			triageresult.Table:                     triageresult.ValidColumn,
			triagerule.Table:                       triagerule.ValidColumn,
			user.Table:                             user.ValidColumn,
			webhooktoken.Table:                     webhooktoken.ValidColumn,
		})
	})
