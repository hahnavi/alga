...
func (_c *NotificationCreate) SetTriggeredByUserID(v string) *NotificationCreate {
...
func (_c *NotificationCreate) SetNillableTriggeredByUserID(v *string) *NotificationCreate {
	if v != nil {
...
func (_c *NotificationCreate) SetTriggeredByDisplayName(v string) *NotificationCreate {
	_c.mutation.SetTriggeredByDisplayName(v)
	return _c
}

// SetNillableTriggeredByDisplayName sets the "triggered_by_display_name" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableTriggeredByDisplayName(v *string) *NotificationCreate {
	if v != nil {
		_c.SetTriggeredByDisplayName(*v)
	}
	return _c
}
...
func (_c *NotificationCreate) defaults() {
	...
	if _, ok := _c.mutation.TriggeredByUserID(); !ok {
		v := notification.DefaultTriggeredByUserID
		_c.mutation.SetTriggeredByUserID(v)
	}
	if _, ok := _c.mutation.TriggeredByDisplayName(); !ok {
		v := notification.DefaultTriggeredByDisplayName
		_c.mutation.SetTriggeredByDisplayName(v)
	}
...
func (_c *NotificationCreate) createSpec() (*Notification, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TriggeredByDisplayName(); ok {
		_spec.SetField(notification.FieldTriggeredByDisplayName, field.TypeString, value)
		_node.TriggeredByDisplayName = value
	}
