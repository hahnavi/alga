...
func (_q *OIDCProviderQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OIDCProviderQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OIDCProviderQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OIDCProviderQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OIDCProviderQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OIDCProviderQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OIDCProviderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oidcprovider.Table, oidcprovider.Columns, sqlgraph.NewFieldSpec(oidcprovider.FieldID, field.TypeUUID))
	_spec.From = _q.sql
