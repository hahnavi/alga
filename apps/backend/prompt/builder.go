...
func incidentRoleInstructions(role, incidentStatus string) string {
	...
	// Other roles don't need it; their work is driven by investigation dispatch
	// and commander coordination.
