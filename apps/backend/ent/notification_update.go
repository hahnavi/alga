...
func (_u *NotificationUpdate) SetTriggeredByUserID(v string) *NotificationUpdate {
...
func (_u *NotificationUpdate) SetNillableTriggeredByUserID(v *string) *NotificationUpdate {
	if v != nil {
...
// ClearTriggeredByUserID clears the value of the "triggered_by_user_id" field.
func (_u *NotificationUpdate) ClearTriggeredByUserID() *NotificationUpdate {
	_u.mutation.ClearTriggeredByUserID()
	return _u
}

// SetTriggeredByDisplayName sets the "triggered_by_display_name" field.
func (_u *NotificationUpdate) SetTriggeredByDisplayName(v string) *NotificationUpdate {
	_u.mutation.SetTriggeredByDisplayName(v)
	return _u
}

// SetNillableTriggeredByDisplayName sets the "triggered_by_display_name" field if the given value is not nil.
func (_u *NotificationUpdate) SetNillableTriggeredByDisplayName(v *string) *NotificationUpdate {
	if v != nil {
		_u.SetTriggeredByDisplayName(*v)
	}
	return _u
}

// ClearTriggeredByDisplayName clears the value of the "triggered_by_display_name" field.
func (_u *NotificationUpdate) ClearTriggeredByDisplayName() *NotificationUpdate {
	_u.mutation.ClearTriggeredByDisplayName()
	return _u
}
...
func (_u *NotificationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.TriggeredByUserID(); ok {
		_spec.SetField(notification.FieldTriggeredByUserID, field.TypeString, value)
	}
	if _u.mutation.TriggeredByUserIDCleared() {
		_spec.ClearField(notification.FieldTriggeredByUserID, field.TypeString)
	}
	if value, ok := _u.mutation.TriggeredByDisplayName(); ok {
		_spec.SetField(notification.FieldTriggeredByDisplayName, field.TypeString, value)
	}
	if _u.mutation.TriggeredByDisplayNameCleared() {
		_spec.ClearField(notification.FieldTriggeredByDisplayName, field.TypeString)
	}
...
// SetTriggeredByUserID sets the "triggered_by_user_id" field.
func (_u *NotificationUpdateOne) SetTriggeredByUserID(v string) *NotificationUpdateOne {
	_u.mutation.SetTriggeredByUserID(v)
	return _u
}

// SetNillableTriggeredByUserID sets the "triggered_by_user_id" field if the given value is not nil.
func (_u *NotificationUpdateOne) SetNillableTriggeredByUserID(v *string) *NotificationUpdateOne {
	if v != nil {
		_u.SetTriggeredByUserID(*v)
	}
	return _u
...
// ClearTriggeredByUserID clears the value of the "triggered_by_user_id" field.
func (_u *NotificationUpdateOne) ClearTriggeredByUserID() *NotificationUpdateOne {
	_u.mutation.ClearTriggeredByUserID()
	return _u
}

// SetTriggeredByDisplayName sets the "triggered_by_display_name" field.
func (_u *NotificationUpdateOne) SetTriggeredByDisplayName(v string) *NotificationUpdateOne {
	_u.mutation.SetTriggeredByDisplayName(v)
	return _u
}

// SetNillableTriggeredByDisplayName sets the "triggered_by_display_name" field if the given value is not nil.
func (_u *NotificationUpdateOne) SetNillableTriggeredByDisplayName(v *string) *NotificationUpdateOne {
	if v != nil {
		_u.SetTriggeredByDisplayName(*v)
	}
	return _u
...
// ClearTriggeredByDisplayName clears the value of the "triggered_by_display_name" field.
func (_u *NotificationUpdateOne) ClearTriggeredByDisplayName() *NotificationUpdateOne {
	_u.mutation.ClearTriggeredByDisplayName()
	return _u
}
