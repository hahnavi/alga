...
func (_q *PlaybookQuery) QueryService() *ServiceQuery {
...
func (_q *PlaybookQuery) QueryCreatedByUser() *UserQuery {
...
func (_q *PlaybookQuery) QuerySteps() *PlaybookStepQuery {
	query := (&PlaybookStepClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *PlaybookQuery) WithService(opts ...func(*ServiceQuery)) *PlaybookQuery {
	query := (&ServiceClient{config: _q.config}).Query()
...
func (_q *PlaybookQuery) WithCreatedByUser(opts ...func(*UserQuery)) *PlaybookQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlaybookQuery) WithSteps(opts ...func(*PlaybookStepQuery)) *PlaybookQuery {
	query := (&PlaybookStepClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlaybookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Playbook, error) {
	...
	if query := _q.withService; query != nil {
		if err := _q.loadService(ctx, query, nodes, nil,
			func(n *Playbook, e *Service) { n.Edges.Service = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCreatedByUser; query != nil {
		if err := _q.loadCreatedByUser(ctx, query, nodes, nil,
			func(n *Playbook, e *User) { n.Edges.CreatedByUser = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSteps; query != nil {
		if err := _q.loadSteps(ctx, query, nodes,
			func(n *Playbook) { n.Edges.Steps = []*PlaybookStep{} },
			func(n *Playbook, e *PlaybookStep) { n.Edges.Steps = append(n.Edges.Steps, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PlaybookQuery) loadService(ctx context.Context, query *ServiceQuery, nodes []*Playbook, init func(*Playbook), assign func(*Playbook, *Service)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Playbook)
	for i := range nodes {
...
func (_q *PlaybookQuery) loadCreatedByUser(ctx context.Context, query *UserQuery, nodes []*Playbook, init func(*Playbook), assign func(*Playbook, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Playbook)
	for i := range nodes {
...
func (_q *PlaybookQuery) loadSteps(ctx context.Context, query *PlaybookStepQuery, nodes []*Playbook, init func(*Playbook), assign func(*Playbook, *PlaybookStep)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(playbookstep.FieldPlaybookID)
	}
	query.Where(predicate.PlaybookStep(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(playbook.StepsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "playbook_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *PlaybookQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withService != nil {
			_spec.Node.AddColumnOnce(playbook.FieldServiceID)
		}
		if _q.withCreatedByUser != nil {
			_spec.Node.AddColumnOnce(playbook.FieldCreatedBy)
		}
	}
