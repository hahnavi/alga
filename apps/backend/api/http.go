...
func (s *Server) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/alerts/", s.authMiddleware(s.handleAlertByNumber))
	...
	mux.HandleFunc("/api/v1/routes", s.authMiddleware(s.handleRoutes))
	mux.HandleFunc("/api/v1/knowledge", s.authMiddleware(s.handleKnowledge))
	mux.HandleFunc("/api/v1/knowledge/", s.authMiddleware(s.handleKnowledgeByID))
	mux.HandleFunc("/api/v1/memories", s.authMiddleware(s.handleMemories))
	mux.HandleFunc("/api/v1/memories/", s.authMiddleware(s.handleMemoryByID))
	...
	mux.HandleFunc("/api/v1/destinations", s.authMiddleware(s.handleDestinations))
	mux.HandleFunc("/api/v1/integrations", s.authMiddleware(s.handleIntegrations))
	...
	mux.HandleFunc("/api/v1/dashboard/daily-summary", s.authMiddleware(s.handleDailySummary))
	...
	mux.HandleFunc("/api/v1/action-items", s.authMiddleware(s.handleGlobalActionItems))
	mux.HandleFunc("/api/v1/post-mortems", s.authMiddleware(s.handlePostMortemsList))
	...
	mux.HandleFunc("/api/v1/system/config", s.authMiddleware(s.handleSystemConfig))
	...
	mux.HandleFunc("/api/v1/maintenance-windows", s.authMiddleware(s.handleMaintenanceWindows))
	mux.HandleFunc("/api/v1/maintenance-windows/", s.authMiddleware(s.handleMaintenanceWindowByID))
	...
	mux.HandleFunc("/api/v1/heartbeats/", s.authMiddleware(s.handleHeartbeatByID))
	...
	mux.HandleFunc("/api/v1/status-pages/", s.authMiddleware(s.handleStatusPageRoutes))
	...
	mux.HandleFunc("/api/v1/incidents/metrics", s.authMiddleware(s.handleIncidentMetrics))
	mux.HandleFunc("/api/v1/incidents", s.authMiddleware(s.withIdempotency("incident:create", s.handleIncidents)))
	mux.HandleFunc("/api/v1/incidents/", s.authMiddleware(s.handleIncidentRoutes))
	...
	mux.HandleFunc("/api/v1/incidents/{id}/ics/roles", s.authMiddleware(s.handleICSRoles))
	mux.HandleFunc("/api/v1/incidents/{id}/ics/roles/", s.authMiddleware(s.handleICSRoleRoutes))
	mux.HandleFunc("/api/v1/incidents/{id}/ics/document", s.authMiddleware(s.handleICSDocument))
	mux.HandleFunc("/api/v1/incidents/{id}/ics/document/", s.authMiddleware(s.handleICSDocumentRoutes))
	mux.HandleFunc("/api/v1/incidents/{id}/begin-triage", s.authMiddleware(s.handleBeginTriage))
	mux.HandleFunc("/api/v1/incidents/{id}/promote", s.authMiddleware(s.handlePromote))
	...
	mux.HandleFunc("/api/v1/triage/rules/", s.authMiddleware(s.handleTriageRuleByID))
	mux.HandleFunc("/api/v1/triage/results", s.authMiddleware(s.handleTriageResults, rbac.TriageRead))
	mux.HandleFunc("/api/v1/triage/results/", s.authMiddleware(s.handleTriageResultByID))
