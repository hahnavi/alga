...
func (_q *SystemConfigQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *SystemConfigQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *SystemConfigQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *SystemConfigQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *SystemConfigQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *SystemConfigQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(systemconfig.FieldConfig).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.SystemConfig.Query().
//		Select(systemconfig.FieldConfig).
//		Scan(ctx, &v)
...
func (_q *SystemConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemconfig.Table, systemconfig.Columns, sqlgraph.NewFieldSpec(systemconfig.FieldID, field.TypeUUID))
	_spec.From = _q.sql
