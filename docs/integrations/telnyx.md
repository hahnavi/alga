...
| `TELNYX_TTS_VOICE`       |          | No          | TTS voice for spoken prompts (e.g. `Polly.Brian`, `Azure.en-CA-ClaraNeural`, `ElevenLabs.eleven_flash_v2_5.<voice_id>`). Leave blank to use the free Telnyx voice |
| `TELNYX_TTS_LANGUAGE`    |          | No          | TTS language. Leave blank to use the free Telnyx voice default                                                                                                    |
