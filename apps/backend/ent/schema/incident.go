...
func (Incident) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("impact_level").Default("medium"),
		field.String("priority").Default("P4"),
		field.String("incident_type").Default("real"),
		...
		field.String("commander_assignee_type").Default("user").Optional(),
		field.String("communicator_assignee_type").Default("user").Optional(),
